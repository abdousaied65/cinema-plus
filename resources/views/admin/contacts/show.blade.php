                    ...
                    <div class="mailbox-header d-flex justify-content-between"
                        ...
                        <div class="p-3">
                            ...
                            <div class="mt-3 font-13">
                                ...
                                <a class="text-muted ml-5" href="javascript:;">( {{$message->email}} )</a> <br>
                        ...
                        <div class="inbox-toolbar m-l-20">
                            <button class="btn btn-default btn-sm" data-action="reply" data-toggle="tooltip"
                                    data-original-title="{{trans('msgs.Reply')}}"><i class="fa fa-reply"></i></button>
                            ...
                            <button class="btn btn-default btn-sm" data-toggle="tooltip"
                                    ...
                                    data-original-title="{{trans('msgs.Print')}}"><i class="fa fa-print"></i></button>
                        </div>
                    </div>
