                    ...
                    <div class="mailbox-header">
                        <div class="d-flex justify-content-between">
                            <h5 class="d-none d-lg-block inbox-title ml-3"><i
                                    class="fa fa-envelope-o m-r-5"></i> {{trans('msgs.Trash')}} ({{$data->total()}})
                            </h5>
                            ...
                            @if(($data)->count() >0)
                                <div class="d-flex" style="padding: 10px;">
                                    ...
                                    <div id="inbox-actions" class="m-l-20 m-r-20">
                                        ...
                                        @csrf
                                        @method('POST')
                                        <button formaction="{{route('admin.contacts.restore.trashed')}}" type="submit"
                                                class="btn btn-default btn-sm" data-toggle="tooltip"
                                                data-original-title="{{trans('msgs.Restore')}}"><i
