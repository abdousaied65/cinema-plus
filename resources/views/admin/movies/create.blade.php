                ...
                <div class="card-header pb-0">
                    <div class="col-12">
                        ...
                        <h5 style="min-width: 300px;" class="pull-left alert alert-sm alert-success">
                            {{trans('msgs.Add New Movie')}}
                        </h5>
                    </div>
                </div>
                <div class="card-body p-1 m-1">
                    <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                          action="{{route('admin.movies.store','test')}}" enctype="multipart/form-data" method="post">
                        {{csrf_field()}}
                        <div class="">
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                <label> {{trans('msgs.Story')}} : {{trans('msgs.English')}} <span
                                        class="text-danger">*</span></label>
                                <textarea dir="ltr" class="form-control text-left" required name="story" id="" rows="5"></textarea>
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                <label> {{trans('msgs.Story')}} : {{trans('msgs.Arabic')}} <span
                                        class="text-danger">*</span></label>
                                <textarea dir="rtl" class="form-control text-right" required name="story_ar" id="" rows="5"></textarea>
