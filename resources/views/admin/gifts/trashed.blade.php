                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-12 margin-tb">
                            ...
                            <h5 style="min-width: 300px;"
                                class="pull-left alert alert-sm alert-danger">{{trans('msgs.Show Trashed Gifts')}}</h5>
                        </div>
                        <br>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table mg-b-0 text-md-nowrap table-hover " id="example-table">
                            ...
                            <tr>
                                ...
                                <th class="text-center">{{trans('msgs.Restore')}}</th>
                            </tr>
                            </thead>
                            <tbody>
                            @php
                            ...
                            @foreach ($data as $key => $gift)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <form class="d-inline"
                                              action="{{route('admin.gifts.restore.trashed',$gift->id)}}"
                                              method="POST">
                                            @csrf
                                            @method('POST')
