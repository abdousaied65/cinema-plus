                ...
                <div class="card-header pb-0">
                    <div class="col-12">
                        ...
                        <h5 style="min-width: 300px;" class="pull-left alert alert-sm alert-success">
                            {{trans('msgs.Edit Existing Member')}}
                        </h5>
                    </div>
                </div>
                <div class="card-body p-1 m-1">
                    <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                          action="{{route('admin.members.update',$member->id)}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        @method('PATCH')
                        <div class="">
                            <div class="row mg-b-20">
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                    ...
                                    <input class="form-control mg-b-20" value="{{$member->name}}"
                                           data-parsley-class-handler="#lnWrapper" name="name" required="" type="text">
                                </div>

                                <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                    <label> {{trans('msgs.Email')}} : <span class="text-danger">*</span></label>
                                    <input class="form-control  mg-b-20" style="text-align: left;direction:ltr;"  value="{{$member->email}}"
                        ...
                        <div class="row mg-b-20">
                            ...
                            <div class="col-lg-6 mb-2">
                                ...
                                <img src="{{asset($member->avatar)}}" id="pic"style="width: 100px; height:100px;"/>
                            </div>
