    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mg-b-20">
                <div class="card-body">
                    <div class="col-12">
                        <a class="btn btn-primary btn-md pull-right" href="{{ route('admin.roles.index') }}">{{trans('msgs.Back')}}</a>
                        <h5 style="min-width: 300px;" class="pull-left alert alert-sm alert-success">{{trans('msgs.Edit')}}
                            {
                            @if(App::getLocale() == 'ar')
                                {{ $role->name_ar }}
                            @else
                    ...
                    <div class="main-content-label mg-b-5">
                        <div class="row">
                            <div class="form-group col-lg-6">
                                <p>{{trans('msgs.Privilege Name')}} {{trans('msgs.English')}} :</p>
                                <input type="text" value="{{$role->name}}" readonly name="name" placeholder="{{trans('msgs.Name')}}"
                                       class="form-control">
                            </div>
                            <div class="form-group col-lg-6">
                                <p>{{trans('msgs.Privilege Name')}} {{trans('msgs.Arabic')}} :</p>
                                <input type="text" value="{{$role->name_ar}}" readonly name="name_ar" placeholder="{{trans('msgs.Name')}}"
                                       class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                            <button type="submit" class="btn btn-info">{{trans('msgs.Update')}}</button>
                        </div>
                        <!-- /col -->
                    </div>
                </div>
