                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-12 margin-tb">
                            ...
                            <a class="btn pull-right btn-danger btn-md" style="margin-right: 20px"
                               href="{{ route('admin.cities.trashed') }}">
                                <i class="fa fa-eye"></i> {{trans('msgs.Show Trashed Cities')}} </a>
                            <h5 style="min-width: 300px;"
                                class="pull-left alert alert-sm alert-success">{{trans('msgs.Display All Cities')}}</h5>
                        </div>
                        <br>
                    </div>
                </div>
                            ...
                            @foreach ($cities as $key => $city)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a class="modal-effect btn btn-md btn-danger delete_city"
                                           city_id="{{ $city->id }}"
                                           city_name="{{ $city->name }}" data-toggle="modal" href="#modaldemo9"
                                           title="Delete"><i
                ...
                <div class="modal-content modal-content-demo">
                    <div class="modal-header text-center">
                        <h6 class="modal-title w-100"
                            style="font-family: 'Cairo'; ">{{trans('msgs.Delete City')}}</h6>
                    ...
                    <form action="{{ route('admin.cities.destroy', 'test') }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input class="form-control" name="cityname" id="cityname" type="text" readonly>
                        </div>
...
<script>
    $(document).ready(function () {
        $('.delete_city').on('click', function () {
            ...
            $('.modal-body #cityname').val(city_name);
        });
    });
</script>
