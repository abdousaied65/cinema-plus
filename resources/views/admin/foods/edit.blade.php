                ...
                <div class="card-header pb-0">
                    <div class="col-12">
                        ...
                        <h5 style="min-width: 300px;" class="pull-left alert alert-sm alert-success">
                            {{trans('msgs.Edit Food')}}
                        </h5>
                    </div>
                </div>
                <div class="card-body p-1 m-1">
                    <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                          action="{{route('admin.foods.update',$food->id)}}" enctype="multipart/form-data" method="post">
                        {{csrf_field()}}
                        @method('PATCH')
                        <div class="">
                            <div class="row mg-b-20">
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                    ...
                                    <input value="{{$food->name}}" dir="ltr" class="form-control mg-b-20 text-left"
                                           data-parsley-class-handler="#lnWrapper" name="name" required="" type="text">
                                </div>
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                    <label> {{trans('msgs.Name')}} : {{trans('msgs.Arabic')}} <span class="text-danger">*</span></label>
                                    <input value="{{$food->name_ar}}" dir="rtl" class="form-control mg-b-20 text-right"
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                ...
                                <textarea dir="ltr" class="form-control text-left" required name="description" id=""
                                          rows="5">{{$food->description}}</textarea>
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                ...
                                <textarea dir="rtl" class="form-control text-right" required name="description_ar" id=""
                                          rows="5">{{$food->description_ar}}</textarea>
                        ...
                        <div class="row mg-b-20">
                            ...
                            <div class="col-lg-4 mb-2">
                                ...
                                <img src="{{asset($food->image)}}" id="pic" style="width: 100px; height:100px;"/>
                            </div>

                            <div class="col-lg-4 mb-2">
                                <label for=""> {{__('msgs.Price')}} </label>
                                <input value="{{$food->price}}" type="text" required name="price" class="form-control"> <br>
                            </div>
                        </div>
                        <br>
