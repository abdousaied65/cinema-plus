                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-lg-12 margin-tb">
                            ...
                            <h5 style="min-width: 300px;"
                                class="pull-left alert alert-sm alert-danger">{{trans('msgs.Show Trashed Genres')}}</h5>
                        </div>
                        <br>
                    </div>
                </div>
                        ...
                        <table class="table mg-b-0 text-md-nowrap table-hover " id="example-table">
                            ...
                            @foreach ($data as $key => $genre)
                                <tr class="text-center">
                                    ...
                                    <td>{{ $genre->name_ar }}</td>
                                    <td>
                                        <form class="d-inline" action="{{route('admin.genres.restore.trashed',$genre->id)}}" method="POST">
                                            @csrf
                                            @method('POST')
