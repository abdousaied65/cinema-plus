                ...
                <div class="tab-area">
                    <div class="tab-item active">
                        <form class="ticket-search-form" @if(App::getLocale() == "ar") dir="rtl" @else dir="ltr"
                              @endif  method="get"
                              action="{{route('filter.movies.by.search')}}">
...
{{--                                <input type="text" name="search" placeholder="{{trans('msgs.Search for Movies')}}">--}}
                                <button type="submit" class="btn btn-block btn-danger btn-lg" style="margin-top: 30px; height: 40px;"><i class="fas fa-search"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-sm-10 col-md-8 col-lg-3">
                    <div class="widget-1 widget-check">
                        <div class="widget-header">
                            ...
                            <a href="{{route('now.showing')}}" class="clear-check">{{trans('msgs.Clear All')}}</a>
                        </div>
                        <div class="widget-1-body">
                            <form action="{{route('filter.movies.by.genre')}}" method="GET">
                    ...
                    <div class="widget-1 widget-check">
                        <div class="widget-1-body">
                            <form action="{{route('filter.movies.by.star')}}" method="GET">
                    ...
                    <div class="filter-tab tab">
                        <div class="filter-area">
                            <div class="filter-main">
                                <div class="row mb-10 p-2 text-right">
                                    <p class="pull-right">{{trans('msgs.Now Showing Movies')}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="tab-area">
                            <div class="tab-item active">
                                <div class="row mb-10 justify-content-center">
                                    @if (!$now_showing_shows->isEmpty())
                                        @foreach($now_showing_shows as $show)
                                                    ...
                                                    <div class="movie-thumb c-thumb">
                                                        ...
                                                        <a href="{{route('show.details',$show->id)}}">
                                                            ...
                                                            <div class="product-label">
                                                                <span class="new">{{trans('msgs.Now Showing')}}</span>
                                                            </div>
                                                        </a>
                                                    </div>
                                        ...
                                        @endforeach
                                    @else
                                        <p class="alert w-100 alert-danger alert-sm p-1 m-5 text-center">
                        ...
                        <div class="text-center">
                            <span @if(App::getLocale()=="ar") dir="rtl"
                                  class="text-center" @else @endif>{{ $now_showing_shows->withQueryString()->links() }}</span>
                        </div>
                    </div>
                </div>
            </div>
